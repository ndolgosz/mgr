...
public class DynamicsFunctions {
	...
	public Object[] distanceToBM(Net net, int BM, int agent) {
		Random r = new Random();
		int i = r.nextInt(net.numVertices) + 1;
		Object[] agents = {i, net.agentsVertices.get(i)};
		return agents;
	}
	...
	public Plot2DPanel[] optimalGroup_kappa_tau(double[][] Tnk, int t, double[] n_axis,
			double[] k_axis) {
