...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
         * HashMap<Integer,HashMap<Integer,Double>> T_fun_map = new
         * SynchronyParameterT().processDynamics(); for (Integer key :
         * T_fun_map.keySet()) { for (Integer key2 :
         * T_fun_map.get(key).keySet()){ System.out.println(key + " "+
         * key2+" "+T_fun_map.get(key).get(key2)); } }
         */

        // BUILDING JFRAME
        JFrame frame = new JFrame("a plot panel");

        frame.setContentPane(new PlotCt_K().createPlot());
